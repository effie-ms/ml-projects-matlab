function [predicted,actual,testSet,b] = EvaluateMyLinearRegression(X, nFolds,learningRate, nEpoch, coeffMethod)
%EVALUATEALGORITHM Evaluate an algorithm using a cross validation split
    ...
    for i = 1:nFolds
        ...
        [predicted,b] = PredictMyLinearRegression(trainSet, testSet,coeffMethod,learningRate, nEpoch);
        actual = folds(i,:,dX)';
